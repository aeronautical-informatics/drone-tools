...
var Configurator = React.createClass({
    ...
    writeSetupImpl: function () {
        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(esc) {
    ...
    resetPWMFrecuency: function resetPWMFrecuency() {
        var _this4 = this;

        var newSettings = [];

        this.state.escSettings.forEach(function (settings, index) {
            if (!_this4.state.escMetainfo[index].available) {
                newSettings.push({});
                return;
            }
            var defaultsPWM = BLHELI_S_PWM[settings.LAYOUT_REVISION];
    ...
    flashOne: function () {
        var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(escIndex) {
    ...
    flashFirmwareImpl: function () {
        var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(escIndex, escSettings, escMetainfo, flashImage, eepromImage, notifyProgress, resetPWMFrecuency) {
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 16:
                            ...
                            _context7.next = 19;
                            return selectInterfaceAndFlash(initFlashResponse);
        ...
        function flashFirmwareImpl(_x3, _x4, _x5, _x6, _x7, _x8, _x9) {
    ...
    flashAll: function () {
        var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(hex, eep) {
            var _this5 = this;

            var firstAvailableMetainfo, interfaceMode, signature, isAtmel, flashSize, flash, eeprom, MCU, firstBytes, ljmpReset, ljmpCheckBootload, _MCU2, i, escIndex, escSettings, escMetainfo, startTimestamp, elapsedSec;
                ...
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            ...
                            flashSize = function () {
                                switch (interfaceMode) {
                                    ...
                                    case _4way_modes.SiLBLB:
                                        {
                                            var MCU = findMCU(signature, _this5.state.supportedESCs.signatures[BLHELI_TYPES.BLHELI_S_SILABS]) || findMCU(signature, _this5.state.supportedESCs.signatures.SiLabs);
                                            return MCU.flash_size;
                                        }
                                    case _4way_modes.AtmBLB:
                                    case _4way_modes.AtmSK:
                                        {
                                            var _MCU = findMCU(signature, _this5.state.supportedESCs.signatures.Atmel);
                        ...
                        case 18:
                            ...
                            if (!(!(MCU.includes('#BLHELI#') || MCU.includes('#BLHELI$')) || !compare(firstBytes, ljmpReset) && !compare(firstBytes, ljmpCheckBootload))) {
                                _context8.next = 25;
                                break;
                            }
                        ...
                        case 31:
                            ...
                            _context8.next = 40;
                            return this.flashFirmwareImpl(escIndex, escSettings, escMetainfo, flash, eeprom, function (progress) {
                                _this5.setState({ flashingEscProgress: progress });
                            });
                        ...
                        case 45:
                            _context8.prev = 45;
                            _context8.t6 = _context8['catch'](36);
            ...
            }, _callee8, this, [[4, 55], [36, 45]]);
        }));

        function flashAll(_x10, _x11) {
    ...
    renderIndividualSettings: function renderIndividualSettings() {
        ...
        return this.state.escMetainfo.map(function (info, idx) {
            ...
            return React.createElement(IndividualSettings, {
                ...
                canFlash: !_this6.state.isFlashing,
                isFlashing: _this6.state.flashingEscIndex === idx,
